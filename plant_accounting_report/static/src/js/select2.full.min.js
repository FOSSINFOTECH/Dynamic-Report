                            ...
                            (d.prototype._attachCloseHandler = function (b) {
                                a(document.body).on(
                                    ...
                                    function (b) {
                                        var c = a(b.target),
                                            d = c.closest(".select2");
                                        a(".select2.select2-container--open").each(
                                            function () {
                                                var b = a(this);
                                                this != d[0] &&
                ...
                b.define("select2/selection/placeholder", ["../utils"], function (a) {
                    ...
                    return (
                        ...
                        (b.prototype.update = function (a, b) {
                            var c = b.length == 1 && b[0].id != this.placeholder.id;
                    ...
                    function (a, b, c) {
                        ...
                        return (
                            ...
                            (d.prototype.item = function (a) {
                                var b = {};
                                if ((b = c.data(a[0], "data")) != null) return b;
                                if (a.is("option"))
                                    b = {
                                        id: a.val(),
                                        text: a.text(),
                    ...
                    return (
                        ...
                        (a.prototype._handleSelectOnClose = function (a, b) {
                            if (b && b.originalSelect2Event != null) {
                                ...
                                if (c._type === "select" || c._type === "unselect")
                                    return;
                            }
